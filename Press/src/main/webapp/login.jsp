    ...
    <div class="login-main">
        ...
        <form class="layui-form login-bottom" id="form">
            <div class="center">
                ...
                <span id="password_err" class="errorMsg">${loginError}</span>
                <%--<div class="layui-form-item" style="text-align:center;">
                    <input type="checkbox" name="identity" lay-filter="oneCheck" value="1" lay-skin="primary" title="超级管理员">
                    <input type="checkbox" name="identity" lay-filter="oneCheck" value="2" lay-skin="primary" title="普通管理员">
                    <input type="checkbox" name="identity" lay-filter="oneCheck" value="3" lay-skin="primary" title="用户">
                </div>--%>
            </div>
            <div class="tip">
                <div class="layui-form-item">
                    <input type="checkbox" id="user_remember_me" name="rememberMe" lay-filter="check"  title="记住我">
                    <div id="register">
                        <b></b>
                        <a href="register.jsp">没有账号？点击注册</a>
                    </div>
            ...
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <input type="submit" id="login" class="login-btn preservation" lay-submit="" lay-filter="login" value="login up"/>
            </div>
        </form>
    </div>
</div>
