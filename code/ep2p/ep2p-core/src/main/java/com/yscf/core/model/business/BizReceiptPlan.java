...
public class BizReceiptPlan extends BaseEntity {
    ...
    /**
     * 加息是否收款 0 表示未收款  1表示已收款
     */
    private String netHikeStatus;
    ...
    private BigDecimal dueinTotalValue;//应收总额
	...
	public String getNetHikeStatus() {
		return netHikeStatus;
	}

	public void setNetHikeStatus(String netHikeStatus) {
		this.netHikeStatus = netHikeStatus;
	}
