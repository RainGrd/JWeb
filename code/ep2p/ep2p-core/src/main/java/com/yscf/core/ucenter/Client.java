...
public class Client extends PHPFunctions{
	...
	public static String UC_IP = "120.26.114.139";
	public static String UC_API = "http://bbs.applj.com/uc_server";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "1qaz2wsx";
	public static String UC_APPID = "5";
	public static String UC_CLIENT_VERSION = "1.0";
	public static String UC_CLIENT_RELEASE = "20151021";
	...
	static {
	    InputStream in = Client.class.getClassLoader().getResourceAsStream("ucenter.properties");
...
//			return $uc_controls[$model]->$action($args);
	...
	public static void main(String[] args) {
		...
		String str = client.uc_authcode("www.w3note.com", "ENCODE", "1qaz2wsx");
//		System.out.println(str);

		String str2 = client.uc_authcode("b13dLCS4aWksFhARDLlfzIhkp1BkMF6bdYQk71uESkkbnSE9mAroiwlgcLBX4jHf1XyNgpj0pM8", "DECODE");
...
//		}
	...
	public String uc_app_ls() {
		String returns = call_user_func(UC_API_FUNC, "app", "ls", null);
		return UC_CONNECT.equals("mysql") ? returns : uc_unserialize(returns);
	}
	...
	*/
	...
	public String uc_user_login(String username, String password, int isuid , int checkques , String questionid, String answer) {
		...
		args.put("questionid", questionid);
		args.put("answer",answer);
		String returns = call_user_func(UC_API_FUNC, "user", "login", args);
		return UC_CONNECT .equals("mysql") ? returns : uc_unserialize(returns);
	}
	...
	public String uc_user_synlogin(int uid) {
		Map<String, Object> args = new HashMap<String, Object>();
		args.put( "uid",uid);
		String returns = uc_api_post("user", "synlogin", args);
		return returns;
	}
	...
	public String uc_user_synlogout() {
		String returns = uc_api_post("user", "synlogout", new HashMap<String, Object>());
		return returns;
	}
	...
	public String uc_get_user(String username, int isuid) {
		...
		args.put("username",username );
		args.put("isuid", isuid );
		String returns = call_user_func(UC_API_FUNC, "user", "get_user", args);
		return UC_CONNECT.equals("mysql") ? returns : uc_unserialize(returns);
	}
	/**
	 * 编辑用户
