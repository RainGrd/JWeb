...
public class CustBidStatusWater extends BaseEntity {
    /**
	 * 
	 */
	private static final long serialVersionUID = 551780230648928211L;

	private String pid;

    private String customerId;

    private String upStatus;//变更状态

    private Date effTime;

    private Date expTime;

    private String upDesc;//变更说明
    ...
    private String cusBidStaWatDesc;
    ...
    public String getCusBidStaWatDesc() {
        return cusBidStaWatDesc;
    }

    public void setCusBidStaWatDesc(String cusBidStaWatDesc) {
        this.cusBidStaWatDesc = cusBidStaWatDesc == null ? null : cusBidStaWatDesc.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        CustBidStatusWater other = (CustBidStatusWater) that;
        return (this.getPid() == null ? other.getPid() == null : this.getPid().equals(other.getPid()))
            ...
            && (this.getCusBidStaWatDesc() == null ? other.getCusBidStaWatDesc() == null : this.getCusBidStaWatDesc().equals(other.getCusBidStaWatDesc()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCusBidStaWatDesc() == null) ? 0 : getCusBidStaWatDesc().hashCode());
        return result;
    }
}