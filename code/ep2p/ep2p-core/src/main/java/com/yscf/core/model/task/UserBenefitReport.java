 ...
 * @version v1.0.0
 */
public class UserBenefitReport extends BaseEntity {
	
	private static final long serialVersionUID = 1084773972919741561L;
    ...
    public BigDecimal getUseravg() {
        return useravg;
    }

    public void setUseravg(BigDecimal useravg) {
    ...
    public boolean equals(Object that) {
        ...
        UserBenefitReport other = (UserBenefitReport) that;
        return (this.getPid() == null ? other.getPid() == null : this.getPid().equals(other.getPid()))
            && (this.getAmount() == null ? other.getAmount() == null : this.getAmount().equals(other.getAmount()))
            && (this.getUsernum() == null ? other.getUsernum() == null : this.getUsernum().equals(other.getUsernum()))
            && (this.getUseravg() == null ? other.getUseravg() == null : this.getUseravg().equals(other.getUseravg()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUseravg() == null) ? 0 : getUseravg().hashCode());
