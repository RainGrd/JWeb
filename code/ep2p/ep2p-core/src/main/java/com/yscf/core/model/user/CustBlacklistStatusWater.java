...
public class CustBlacklistStatusWater extends BaseEntity {
    /**
	 * 
	 */
	private static final long serialVersionUID = 5419453187536588854L;
    ...
    private String cusBlaStaWatDesc;
    ...
    public String getCusBlaStaWatDesc() {
        return cusBlaStaWatDesc;
    }

    public void setCusBlaStaWatDesc(String cusBlaStaWatDesc) {
        this.cusBlaStaWatDesc = cusBlaStaWatDesc == null ? null : cusBlaStaWatDesc.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        CustBlacklistStatusWater other = (CustBlacklistStatusWater) that;
        return (this.getPid() == null ? other.getPid() == null : this.getPid().equals(other.getPid()))
            ...
            && (this.getCusBlaStaWatDesc() == null ? other.getCusBlaStaWatDesc() == null : this.getCusBlaStaWatDesc().equals(other.getCusBlaStaWatDesc()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCusBlaStaWatDesc() == null) ? 0 : getCusBlaStaWatDesc().hashCode());
        return result;
    }
}