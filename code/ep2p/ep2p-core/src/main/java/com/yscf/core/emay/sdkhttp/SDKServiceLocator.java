...
public class SDKServiceLocator extends org.apache.axis.client.Service implements SDKService {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 363110559547796898L;
...
//    private java.lang.String SDKService_address = "http://116.58.219.223:8081/sdk/SDKService";
    ...
    public void setSDKServiceAddress(String SDKService_address) {
        this.SDKService_address = SDKService_address;
    }
    ...
    public com.yscf.core.emay.sdkhttp.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yscf.core.emay.sdkhttp.SDKServiceBindingStub _stub = new com.yscf.core.emay.sdkhttp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.yscf.core.emay.sdkhttp.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yscf.core.emay.sdkhttp.SDKServiceBindingStub _stub = new com.yscf.core.emay.sdkhttp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
