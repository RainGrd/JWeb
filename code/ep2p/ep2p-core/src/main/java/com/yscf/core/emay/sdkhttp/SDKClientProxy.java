...
public class SDKClientProxy implements com.yscf.core.emay.sdkhttp.SDKClient {
  private String _endpoint = null;
  private com.yscf.core.emay.sdkhttp.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new com.yscf.core.emay.sdkhttp.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public com.yscf.core.emay.sdkhttp.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
