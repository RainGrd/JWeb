 ...
 *************************************************************************
 */
package com.yscf.api.controller.personalcenter.recharge.llpay;
...
import com.yscf.api.controller.personalcenter.recharge.PayServletController;
 ...
 */
@Controller
@RequestMapping("recharge/llpayNotify")
public class LlpayControllerNotify extends PayServletController {
	
	private final Logger logger = LoggerFactory.getLogger("ll");
	
	@Autowired
	public LlpayControllerNotify(BizRechargeOnlineServiceImpl service) {
		super(service);
	}
