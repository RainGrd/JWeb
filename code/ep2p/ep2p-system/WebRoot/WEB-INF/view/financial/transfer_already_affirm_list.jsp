...
$(document).ready(function(){
	...
	if("true"==isTaskListOpen){
		 ...
		 */
		BizWithdraw.init("#transfer_already_affirm_grid","转账已确认","#transfer_already_affirm_toolbar",{queryStatus:3},3);	
	}
});
</script>
...
<body class="easyui-layout">
	<div data-options="region:'center',border:false">
		<div id="transfer_already_affirm_toolbar" class="easyui-panel" style="border-bottom: 0;">
			<div>
				<!-- 查询条件 -->
				<form action="" method="post" id="transfer_already_affirm_form" name="transfer_already_affirm_form">
					<input type="hidden" value="3" name="queryStatus">
						...
						<table class="beforeloanTable percent90 formTable">
							...
							<tr>
								...
								<input id="auditStatus" name="auditStatus" class="easyui-combobox" editable="false" required="true"  panelHeight="auto"  
				            			data-options="loadFilter:common.dictionaryFilter,valueField:'dictContCode',textField:'dictContName',multiple:false,url:'<%=basePath%>sysDistionaryContentController/selectByDisctCode.shtml?dictCode=ALREADY_TRANSFERED_STATUS'" />
								</td>
								<td></td>
								<td>
									<a href="javascript:void(0);" class="easyui-linkbutton" 
									data-options="iconCls:'icon-search'"
									onclick="BizWithdraw.searchButClick('#transfer_already_affirm_grid',3)">查询</a>
									<a href="javascript:void(0);" class="easyui-linkbutton" 
									data-options="iconCls:'icon-clear'"
									onclick="BizWithdraw.resetButClick('#transfer_already_affirm_form')">重置</a>
								</td>
							</tr>
						</table>	
					</div>
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-export" plain="true"  onclick="BizWithdraw.toDownloadPage('transfer_already_affirm_grid','transfer_already_affirm_form')">导出EXCEL</a>
		</div>
	
		<div class="showDataListWrap">
			<table id="transfer_already_affirm_grid">
			</table>
		</div>
	</div>
</body>