...
<body class="easyui-layout">
	<div data-options="region:'center',border:false">
		<div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
			...
			<!-- 操作按钮 -->	
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"  onclick="newStandard.openAdd(1)">新增新手标</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"  onclick="newStandard.openAdd(2)">新增体验标</a>
		</div>
		
		<div class="showDataListWrap">
			<table id="new_standard_list"></table>
		</div>
		<script type="text/javascript" src="${basePath}resources/js/business/model/newStandard_Model.js" charset="utf-8"></script>
		...
		<script type="text/javascript">
			var setDefault = function () { //加载完成后,设置选中第一项
	           ...
	           if(val.length>0){
	               ...
	               newStandard.initDataGrid(val[0].dictContCode);	
	            }
	        
	        }
			
			window.top["reload_Abnormal_Monitor"]=function(){
				$("#new_standard_list").datagrid("load");
			};
			window.top["reload_New_Standard"]=function(){
				$("#new_standard_list").datagrid("load");
			};
		</script>
	</div>
