...
<body class="easyui-layout">
	<div data-options="region:'center',border:false">
						...
						<table class="userTable percent90">
						  <tr>
							...
							<td>
								...
								<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="frozenAmount.searchData()">查询</a>
								</div>
							</td>
						  </tr>
						</table>
		...
		<script type="text/javascript" src="${basePath}resources/js/custom/toFrozenAmountDetailsList.js"></script>
		<script type="text/javascript" src="${basePath}resources/js/custom/model/toFrozenAmountDetailsListModel.js"></script>
		<script type="text/javascript">
		$(document).ready(function(){
			frozenAmount.initDataGrid();	
		});
		</script>
	</div>
</body>