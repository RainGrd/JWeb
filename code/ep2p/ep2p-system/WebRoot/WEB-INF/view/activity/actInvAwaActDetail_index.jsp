...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/actInvAwaActDetail_index.js" charset="utf-8"></script>
...
<body class="easyui-layout">
	<div data-options="region:'center',border:false">
				...
				<div style="padding: 5px">
					<table class="beforeloanTable formTable">
						...
						<tr>
							...
							<td>
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" onclick="actInvAwaActDetail.searchData()">查询</a>
		...
		<div class="showDataListWrap" id="actInvAwaActDetailGrid_dlg">
			<table id="actInvAwaActDetailGrid" >
			</table>
		</div>
