...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/pubRedpacket_add.js" charset="utf-8"></script>
...
<body class="easyui-layout">
	...
	<div class="easyui-panel" data-options="fit:true" style="width:auto;padding-top:30px;">
		<form id="baseInfo" name="baseInfo" action="<%=basePath%>pubRedpacketController/save.shtml" method="POST">
			...
			<input type="hidden" name="redpacketType" id="redpacketType" value="2" />
			<table class="cus_table formTable percent68">
				...
				<tr>
					<td class="align_right"><label style="color: red;">*</label>红包个数：</td>
					<td><input class="text_style easyui-numberbox" name="repNumber" data-options="required:true" style="width: 200px;" /></td>
					<td class="align_right"><label style="color: red;">*</label>单个红包最高金额：</td>
					<td><input class="text_style easyui-numberbox" name="onlyMaxAmount" data-options="required:true" style="width: 200px;" /></td>
				</tr>
				<tr>
					<td class="align_right"><label style="color: red;">*</label>红包分配方式：</td>
					<td>
						<select class="easyui-combobox" name="allotType" panelHeight="auto" editable="false" >
				...
				<tr>
					...
					<td colspan="4" align="center">
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="pubRedpacket_add.save()">保存</a>
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="pubRedpacket_add.revert()">返回</a>
					</td>
				</tr>
			</table>
		</form>
