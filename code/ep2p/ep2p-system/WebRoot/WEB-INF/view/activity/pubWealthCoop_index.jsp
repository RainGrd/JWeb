...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/pubWealthCoop_index.js" charset="utf-8"></script>
<script type="text/javascript" src="${basePath}resources/js/activity/model/pubWealthCoop_Model.js" charset="utf-8"></script>
	...
	<div data-options="region:'center',border:false">
		<div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
				...
				<div style="padding: 5px">
					<table class="beforeloanTable formTable percent90">
						...
						<tr>
							...
							<td>
								<input class="easyui-textbox" name="wealthCoopName" />
							</td>
						...
						<tr>
							...
							<td>
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" onclick="pubWealthCoop.searchData()">查询</a>
			...
			<div style="padding-bottom:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="pubWealthCoop.openAdd()">新增</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="pubWealthCoop.remove()">删除</a>
			</div>
		</div>
		
		<div class="showDataListWrap">
			<table id="pubWealthCoopGrid" >
			</table>
		</div>
</body>