...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/actVipActDetail_index.js" charset="utf-8"></script>
...
<body class="easyui-layout">
	<div data-options="region:'center',border:false">
				...
				<div style="padding: 5px">
					<table class="beforeloanTable formTable">
						...
						<tr>
							...
							<td>
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" onclick="actVipActDetail.searchData()">查询</a>
		...
		<div class="showDataListWrap" id="actVipActDetailGrid_dlg">
			<table id="actVipActDetailGrid" >
			</table>
		</div>
