...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/pubRedpacket_index.js" charset="utf-8"></script>
<script type="text/javascript" src="${basePath}resources/js/activity/model/pubRedpacket_Model.js" charset="utf-8"></script>
	...
	<div data-options="region:'center',border:false">
		<div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
				...
				<div style="padding: 5px">
					<table class="beforeloanTable formTable percent90">
						...
						<tr>
							...
							<td>
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" onclick="pubRedpacket.searchData()">查询</a>
			...
			<div style="padding-bottom:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="pubRedpacket.openAdd()">新增</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="pubRedpacket.remove()">删除</a>
			</div>
		</div>
