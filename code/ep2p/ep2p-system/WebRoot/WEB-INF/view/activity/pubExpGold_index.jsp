...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/pubExpGold_index.js" charset="utf-8"></script>
<script type="text/javascript" src="${basePath}resources/js/activity/model/pubExpGold_Model.js" charset="utf-8"></script>
	...
	<div data-options="region:'center',border:false">
		<div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
			...
			<form action="" method="post" id="searcm" name="searcm">
				<div style="padding: 5px">
					<table class="beforeloanTable formTable percent90">
						...
						<tr>
							<td class="align_right">体验金名称：</td>
							<td>
								<input class="easyui-textbox" name="expName" />
							</td>
						...
						<tr>
							...
							<td>
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" onclick="pubExpGold.searchData()">查询</a>
			...
			<div style="padding-bottom:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="pubExpGold.openAdd()">新增</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="pubExpGold.remove()">删除</a>
			</div>
		</div>
		
		<div class="showDataListWrap">
			<table id="pubExpGoldGrid" >
			</table>
		</div>
</body>