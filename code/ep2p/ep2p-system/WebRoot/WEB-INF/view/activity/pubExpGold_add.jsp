...
<script type="text/javascript" src="${basePath}resources/js/activity/experience/pubExpGold_add.js" charset="utf-8"></script>
...
<body class="easyui-layout">
	...
	<div class="easyui-panel" data-options="fit:true" style="width:auto;padding-top:30px;">
		<form id="baseInfo" name="baseInfo" action="<%=basePath%>pubExpGoldController/save.shtml" method="POST">
			<input type="hidden" name="pid" id="pid" value="${pid}" />
			<table class="cus_table formTable percent68">
				<tr>
					<td class="align_right"><label style="color: red;">*</label>体验金编号：</td>
					<td><input class="text_style easyui-validatebox"  name="actCode" readonly="readonly" /></td>
					<td class="align_right">体验金标签：</td>
					<td><input class="text_style easyui-validatebox" name="actTag" /></td>
				</tr>
				<tr>
					<td class="align_right"><label style="color: red;">*</label>体验金名称：</td>
					<td><input class="text_style easyui-validatebox" name="expName" data-options="required:true" /></td>
					<td class="align_right"><label style="color: red;">*</label>体验金金额：</td>
					<td><input class="text_style easyui-numberbox" name="expAmount" data-options="required:true" style="width: 200px;" /></td>
				</tr>
				<tr>
					<td class="align_right"><label style="color: red;">*</label>有效期（天）：</td>
					<td><input class="text_style easyui-numberbox" name="expNumber" data-options="required:true" style="width: 200px;" /></td>
				...
				<tr>
					...
					<td colspan="3"><input class="easyui-textbox" name="expGolDesc" data-options="multiline:true,validType:'length[0,120]'" style="width: 634px;height: 80px;" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="4" align="center">
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="pubExpGold_add.save()">保存</a>
						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="pubExpGold_add.revert()">返回</a>
					</td>
				</tr>
			</table>
		</form>
