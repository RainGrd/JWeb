...
<script type="text/javascript" src="${basePath}resources/js/radio/statistics/programe_info.js" charset="utf-8"></script>
	<div data-options="region:'center',border:false">
		<div class="queryTerms">
			<!-- 查询条件 -->
			<form action="" method="post" id="program_search_from">
				<div class="p5">
					<table class="beforeloanTable formTable">
						<tr>
							<td class="label_right">节目名称：</td>
							<td colspan="4">
								<input type="hidden" name="prgpid" id="prgpid" value="${prgpid}">
								<span id="program_id">
									${programTitle}
								</span>
							</td>
						...
						<tr>
							...
							<td>
								<div class="rangDate">
								<select id="timeType_info" class="easyui-combobox" data-options="onSelect:mystatistics.selectTypeInfo" name="timeType">   
							...
							<td>
								<a href="javascript:void(0)" onclick="serarLineReport();" class="easyui-linkbutton"
		...
		<!-- 统计结果 -->
		<div id="detail_statisticResult" class="showDataListWrap">
		</div>
	</div>
</body>