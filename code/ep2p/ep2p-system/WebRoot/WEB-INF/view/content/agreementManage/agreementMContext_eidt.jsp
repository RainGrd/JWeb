...
<div data-options="region:'center',border:false">
	<!-- 表单信息 -->
	<div class="p10">
		<form id="agreementMC_edit_from" method="post" >
		<table class="fromtable">
			<tr>
				 <td class="align_right" > <span class="red">*</span>内容名称：</td>
				 <td >
				 	<input type="hidden" name="pid" id="pid" value="${actext.pid}" />
				 	<input type="hidden" name="agrConTemId" id="agrConTemId" value="${actext.agrConTemId}"/>
				 	<input type="text" class="easyui-textbox" name="agrContName" required="required" value="${actext.agrContName}" > 
				 </td>
				 <td class="align_right" ><span class="red">*</span>关键字：</td>
				 <td>
				 	<input type="text" class="easyui-textbox" name="protocol" required="required" value="${actext.protocol}" >
				 </td>
			</tr>
		</table>
		</form>
