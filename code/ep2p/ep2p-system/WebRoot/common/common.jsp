...
<%@ include file="dictionary-config.jsp"%>
...
<script type="text/javascript" src="${basePath}resources/plugins/highcharts/highcharts.js"></script>
...
<script src="${basePath}resources/js/accounting.js" type="text/javascript"></script>
