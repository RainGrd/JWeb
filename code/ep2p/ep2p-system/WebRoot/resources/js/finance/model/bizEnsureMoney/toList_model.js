var biz_ensure_money_index_model = [[    
    	        {field:'catorTime',title:'日期',width:'12%',align:'center',sortable:true},    
    	        {field:'income',title:'收入',width:'15%',align:'center',sortable:true,formatter:formatIncome},    
    	        {field:'expenditures',title:'支出',width:'15%',align:'center',sortable:true,formatter:formatExpenditures},    
    	        {field:'balance',title:'备付金余额',width:'15%',align:'right',sortable:true,formatter:formatBalanceValue},    
    	        {field:'ensMonDetTypeName',title:'类型',width:'15%',align:'center',sortable:true},    
