 ...
 */
@Controller
@RequestMapping("/alreadyTransferServiceController")
public class AlreadyTransferServiceController extends EscfBaseController {
	private Logger logger = LoggerFactory.getLogger(AlreadyTransferServiceController.class);

	@Autowired
	public AlreadyTransferServiceController(BizWithdrawServiceImpl service) {
		super(service);
	}
	...
	public ModelAndView toList(HttpServletRequest request,
			HttpServletResponse response) throws HttpRequestException {
		return new ModelAndView("/financial/alreadyTransferServiceList");
	}
	 ...
	 * @throws HttpRequestException
	 */
	/*@RequestMapping(value = "/alreadyTransferServiceListData")
	@ResponseBody
	public ModelAndView logList(HttpServletRequest request,
		...
		try {
			...
			PageList<BizWithdraw> list = service.selectAlreadyTransferServiceAllPage(parasMap, info);
...
//			bizWithdraw.setWitSureDesc(request.getParameter("witSureDesc"));
//			// 根据主键批量审核
