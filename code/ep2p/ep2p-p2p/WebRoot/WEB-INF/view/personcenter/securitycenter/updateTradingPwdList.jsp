...
<%@include file="/common/common.jsp" %>
	<div class="goumai_vip_b">
			<div class="vip_g_b"></div>
			<div class="vip_g_bs m_auto h350">
				<div class="ge_ye_tilte">
							<span class="ge_ye_tilte_nav  ms_t_se">修改交易密码</span>
				</div>
...
<!-- 										确认登陆密码不能为空！确认登陆密码与新密码不一致！ -->
			...
			<p class="lh45 w360 m_auto">
				<span class="w115 inline_block tr h10"></span><span class=""><a class="btn_samll ml15" href="javascript:myPerson_data.saveTradPwd();">保存修改</a></span>
			</p>
			<div class="kong35"></div>
		</div>
