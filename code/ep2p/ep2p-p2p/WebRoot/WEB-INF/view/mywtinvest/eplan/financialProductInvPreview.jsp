        ...
        <div class="dropPopupTab">
        	<div class="dropPopupTabCon">
                ...
                <table class="dropPopupTable">
                    ...
                    <tr>
                    	<td>年化利率：</td>
                        <td><fmt:formatNumber value="${borrow.borrowRate*100}" pattern="##.##" minFractionDigits="2" />% 
	                        <span class="tipsBtn">
	                        	<div class="tipsWrap">
	                                <p>根据收款天数自动计算</p>
	                            </div>
                        ...
                        <td>还款方式：</td>
                        <td><c:out value="${borrow.repaymentTypeName }" />
                        	<span class="tipsBtn">
                        	<div class="tipsWrap">
                	...
                	<tr>
                        ...
                        <td>计息方式：</td>
                        <td><c:out value="${borrow.accrualTypeName }"/><span class="tipsBtn">
                        	<div class="tipsWrap">
                	...
                	<tr>
                    	<td>投资奖励：</td>
                        <td><fmt:formatNumber value="${borrow.investRewardScale*100}" pattern="##.##" minFractionDigits="2" />%<span class="tipsBtn">
                        	<div class="tipsWrap">
			                ...
			                <div class="transfer_info dropPopupInfo fl size14">
			                    <div class="ti1">
			                        <div style="width:50%;" class="fl">可用余额：<font class="colororg">
						                          ￥<fmt:formatNumber value="${availableAmount}" pattern="#,##0.00"></fmt:formatNumber>
			                    ...
			                    <div class="ti3">可投金额：￥${borrow.startMoney==null?0:borrow.startMoney}~${borrow.endMoney==null || borrow.endMoney eq '0.00' ?"":"￥"}${borrow.endMoney==null || borrow.endMoney eq '0.00' ?"不限":borrow.endMoney}</div>
			                    <div class="ti2">
			                        <div style="margin-top:16px;">
			                        	投资金额：<input type="text" value="${investNumber}" id="investmentAmount" name="investmentAmount"  class="dropMonysum dorpInvest" onblur="count(this.value)" style="width: 200px" placeholder="输入投资金额"/><span class="ml024">元</span>
			                        	<span id="imsg2" class="input_tis ts_lh  mt5" style="padding:0 5px;display: none;margin-left: 5px;"></span>
			                        </div>
			                    </div>
			                    <div class="ti4">
			                        <div style="width:40%;" class="fl">投资奖励：<font class="colororg" id="investReward">￥<fmt:formatNumber value="${investReward }" pattern="#,##0.00"/></font></div>
			                    ...
			                    <div class="ti3" style="margin-top:16px;">预期收益：
	                    				<font class="colororg" id="expectAmount">
	                    						￥<fmt:formatNumber value="${expectAmount }" pattern="#,##0.00"/>
	                    				</font>
	                    				<font class="colororg" id="investAward">
	                    				</font>
			                    		<font class="size12 gray">
			                    				包含<fmt:formatNumber value="${discount}" pattern="##.##" minFractionDigits="2" ></fmt:formatNumber>%利息管理费
			                    		</font>
			                    </div>
			                    <div class="ti2" style="margin-top:16px;">
			                        <div>
			                        	交易密码：<input type="password" name="pwd" id="pwd" style="width:116px;" class="pl10" AUTOCOMPLETE="OFF"/>
