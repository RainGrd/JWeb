...
<head>
	...
	<script type="text/javascript" charset="utf-8" src="<%=basePath %>theme/js/activityarea/activityArea.js"></script> 
...
<body>
	...
	<!-- 中心内容 -->
	<div class="content_ac mt40" style="position: relative;z-index: 1;">
		<div class="w1140 m_auto">
			<tiles:insertAttribute name="activityarealeft"></tiles:insertAttribute>
			<tiles:insertAttribute name="activityarearight"></tiles:insertAttribute>
		</div>
	</div>
