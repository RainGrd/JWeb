 ...
 */
@Controller
@RequestMapping("recharge/tenpayReturn")
public class TenpayControllerReturn extends PayServletController {
	
	private final Logger logger = LoggerFactory.getLogger("ten");
	
	@Autowired
	public TenpayControllerReturn(BizRechargeOnlineServiceImpl service) {
		super(service);
	}
	...
	protected void postHandle(HttpServletRequest req, HttpServletResponse resp,
		...
		if(!result.equals(Constant.PAY_UNDEFINED)){
