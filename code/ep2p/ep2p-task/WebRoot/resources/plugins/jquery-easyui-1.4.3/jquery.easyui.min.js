...
if(opts.top<0){ //update by zhengxiu window top value
	opts.top=0;
	opts.height=$(window)._outerHeight();
}
if(_27a){
_26f(_279);
}
...
if($(window)._outerHeight()<opts.height){ //update by zhengxiu  window-body height value
	opts.height=$(window)._outerHeight()-20;
	//opts.style=[{overflow:'scroll'}];
}
...
// update by wzx start
if($(_397.center).find('.tabs-first').hasClass('tabs-selected')){
	if($(_397.west.parent()).css('left')=='0px'){
		_39a(_399(_397.expandWest)?_397.expandWest:_397.west,"w");
		 layout_refreshTab();
	}
}else{
...
// update by zhengxiu  return {resizeC:{width:_3c0,left:_3be-1},expand:{left:0},expandP:{left:0,top:_3bd.top,width:_3be,height:_3bd.height},collapse:{left:-_3bf,top:_3bd.top,height:_3bd.height}};
return {resizeC:{width:_3c0+_3be-1,left:0},expand:{left:-28},expandP:{left:-28,top:_3bd.top,width:_3be,height:_3bd.height},collapse:{left:-28,top:_3bd.top,height:_3bd.height}};
}else{
if(_3b4=="north"){
...
c.insertAfter(_4b2);
// update by zhengxiu if...else if...else...
//opts.width=c.outerWidth();
if($(_4b5).hasClass('rangDate')){//日期范围
	opts.width=100;
}else if($(_4b5.html()).hasClass('easyui-combobox')){
	opts.width=172;
}else{ 
	opts.width=c.outerWidth();
}
