...
function custRepayClick(acctId,cusType,comId) {
	if(cusType==1){
		parent.openNewTab(BASE_PATH+'customerController/editPerBase.action?acctId='+acctId+'&flag=1',"个人客户");
	}else if (cusType==2){
		parent.openNewTab(BASE_PATH+'customerController/editComBases.action?acctId='+acctId+"&comId="+comId+'&flag=1',"企业客户");
	}
